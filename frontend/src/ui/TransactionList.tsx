              ...
              <div className="flex flex-row items-start justify-between gap-2 w-full">
                ...
                <div className="flex items-start gap-2 flex-1 min-w-0">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <div className="text-xs sm:text-sm text-gray-500 flex flex-row flex-wrap items-center gap-1 sm:gap-2">
                      ...
                      {transaccion.periodicidad === 'mensual' && (
                        <span className="px-2 py-1 text-xs bg-blue-100 text-blue-600 rounded w-fit">
