        ...
        <nav className="bg-white shadow-sm border-b">
            <div className="w-full px-6 flex items-center justify-between h-16">
                ...
                <div className="flex items-center gap-3 pr-2">
                    ...
                    <Link to="/login" className="px-4 py-2 bg-white text-blue-700 rounded-lg font-medium hover:bg-blue-50 transition-colors border border-blue-600" onClick={handleLoginClick}>Iniciar Sesión</Link>
                </div>
            </div>
        </nav>
    );
